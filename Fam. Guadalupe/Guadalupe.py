...
if es_admin:
    ...
    if st.session_state.pantalla_actual == "bienvenida":
        ...
        st.markdown("<p style='font-size: 15px; margin-bottom:19px;'>selecciona el método de tu preferencia haciendo clic para desplegar los datos correspondientes:</p>", unsafe_allow_html=True)
