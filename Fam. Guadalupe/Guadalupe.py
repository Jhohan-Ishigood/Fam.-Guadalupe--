...
if es_admin or (st.session_state.pantalla_actual == "catalogo" and not st.session_state.pedido_guardado):
    ...
    with col_der_search:
        placeholder_txt = "Buscar..." if es_admin else "¿BUSQUE AQUI LO QUE NECESITA?"
...
if es_admin:
    ...
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 📈 ANALÍTICA: UNIDADES VENDIDAS DEL DÍA")
    ...
    # ============================================================================
    st.markdown("<br>", unsafe_allow_html=True)
    st.markdown("### 🕒 BITÁCORA: CONTROL HISTÓRICO DE COMPRAS")
    ...
    if st.session_state.pantalla_actual == "bienvenida":
        ...
        st.markdown("""
            <div class='social-footer'>
                ...
                <a href='https://wa.me/51950239350' target='_blank' class='social-icon'>🟢 WhatsApp</a>
            </div>
        """, unsafe_allow_html=True)
