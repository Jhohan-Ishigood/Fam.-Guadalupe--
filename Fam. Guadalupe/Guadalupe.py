...
if es_admin:
    ...
    if st.session_state.pantalla_actual == "bienvenida":
        ...
        st.markdown("<br><p style='text-align: center; font-size: 20px;margin-top: -10px; font-weight: bold; color: #d4af37;'>Bienvenidos al stock de productos disponibles y sus precios🔥</p>", unsafe_allow_html=True)
